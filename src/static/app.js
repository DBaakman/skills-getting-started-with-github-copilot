      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsMarkup = participants.length
          ? `<div class="participants-list">${participants
              .map(
                (participant) => `
                  <span class="participants-item" data-participant="${participant}">
                    <span class="participants-name">${participant}</span>
                    <button type="button" class="participants-remove" aria-label="Remove ${participant}" title="Remove ${participant}">
                      ×
                    </button>
                  </span>`
              )
